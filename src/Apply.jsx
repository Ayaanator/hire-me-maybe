...
function Apply() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 flex flex-col gap-6">
      ...
      <h1 className="text-gray-300">By submitting this application, I consent and give my future employer permission to execute my family if I don't meet  the company's performance goals.</h1>
    </div>
  );
}
